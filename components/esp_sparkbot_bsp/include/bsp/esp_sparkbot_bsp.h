 ...
 **************************************************************************************************/
/* UART */
#define CHATBOT_UART_PORT_NUM    (1)
#define BUF_SIZE                (1024)
#define UART_CHATBOT_TXD         (GPIO_NUM_38)
#define UART_CHATBOT_RXD         (GPIO_NUM_48)
#define UART_CHATBOT_RTS         (-1)
#define UART_CHATBOT_CTS         (-1)
