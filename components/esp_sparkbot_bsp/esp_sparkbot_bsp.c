...
/* I2C bus handle */
static i2c_bus_handle_t i2c_bus_handle0 = NULL;
...
esp_err_t bsp_i2c_init(void)
{
    ...
    const i2c_config_t i2c_bus_conf1 = {
    ...
    i2c_bus_handle1 = i2c_bus_create(BSP_I2C_NUM, &i2c_bus_conf1);

    // const i2c_config_t i2c_bus_conf0 = {
    //     .mode = I2C_MODE_MASTER,
    ...
    // };
    // i2c_bus_handle0 = i2c_bus_create(0, &i2c_bus_conf0);
    ...
    uint8_t addr;
    device_count = i2c_bus_scan(i2c_bus_handle1, &addr, 1);
...
esp_err_t bsp_display_new(const bsp_display_config_t *config, esp_lcd_panel_handle_t *ret_panel, esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    const spi_bus_config_t buscfg = {
        ...
        .miso_io_num = BSP_LCD_RST,
        .quadwp_io_num = BSP_LCD_RST,
        .quadhd_io_num = BSP_LCD_RST,
...
static lv_display_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    printf("LVGL LCD configuration done\n");
...
esp_err_t bsp_uart_init(void)
{
    ...
    ESP_ERROR_CHECK(uart_driver_install(CHATBOT_UART_PORT_NUM, BUF_SIZE * 2, 0, 0, NULL, 0));
    ESP_ERROR_CHECK(uart_param_config(CHATBOT_UART_PORT_NUM, &uart_config));
    ESP_ERROR_CHECK(uart_set_pin(CHATBOT_UART_PORT_NUM, UART_CHATBOT_TXD, UART_CHATBOT_RXD, UART_CHATBOT_RTS, UART_CHATBOT_CTS));
    printf("UART Chatbot initialized\n");
    return ESP_OK;
}
...
void tracked_chassis_motion_control(const char* command_str)
{
    ...
    uart_write_bytes(CHATBOT_UART_PORT_NUM, command_str, len);
